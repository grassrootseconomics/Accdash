              ...
              <Row id="tiles">
                <Col lg={3} className="tile tile-1">
                  <Tile
                    ...
                    value1={format(".3s")(data.registeredUsers[0].total)}
                    trend1={{
                      symbol: this.trend(
                    ...
                    units1={"(total)"}
                    value2={format(".3s")(data.newRegisteredUsers[0].total)}
                    units2={"(new)"}
                    trend2={{
                      symbol: this.trend(
                ...
                <Col lg={3} className="tile tile-2 ">
                  <Tile
                    title={"Traders"}
                    value1={format(".3s")(data.traders[0].total)}
                    units1={"(total)"}
                    trend1={{
                      symbol: this.trend(
                    ...
                    value2={format(".3s")(data.frequentTraders[0].total)}
                    units2={"(frequent)"}
                    trend2={{
                      symbol: this.trend(
